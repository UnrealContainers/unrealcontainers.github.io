...
As of Unreal Engine 4.27, the digital human characters generated by the [MetaHuman Creator](https://www.unrealengine.com/en-US/metahuman-creator) application only render correctly under Windows. If your Unreal Engine application makes use of MetaHuman characters then you will need to use Windows. You should test your application for compatibility with Windows containers first, and fall back to using Windows VMs only if your application is not compatible with containers.
